...
aria.Listbox.prototype.setupFocus = function () {
  if (this.activeDescendant) {
      //console.log('SETUP FOCUS return');
...
aria.Listbox.prototype.checkKeyPress = function (evt) {
  ...
  var nextItem = document.getElementById(this.activeDescendant);
    ...
    //console.log('Entro a checkKeyPress ' + key);

  if (!nextItem) {
      //console.log('checkKeyPress return');
    return;
  }
  ...
  switch (key) {
    ...
    case aria.KeyCode.DOWN:
      evt.preventDefault();
        //console.log('checkKeyPress Boton Down');
    ...
    //console.log('checkKeyPress paso el switch');
};
