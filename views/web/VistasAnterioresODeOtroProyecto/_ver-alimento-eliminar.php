...
<div class="container">
    <div class="row marginVertical-20">
        <div class="col-sm-8 col-lg-8 col-xs-12 col-md-8 text-left marginVertical-20">
            <h1>Confirmar Eliminar Alimento</h1>
        </div>
    ...
    <section class="row">
        <form class="form-horizontal" action="<?= App::$urlPath;?>/abm/abm_alimentos/eliminar" method="post">
            <input id="IDALIMENTO" type="hidden" name="IDALIMENTO" value='<?= $ali->getIdalimento(); ?>' />
            <div class="form-group">
                <label for="NOMBRE_ALIMENTO" class="col-sm-2 control-label">Nombre Alimento: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="NOMBRE_ALIMENTO" type="text" name="NOMBRE_ALIMENTO" value='<?= $ali->getNombreAlimento(); ?>' disabled/>
                </div>
            </div>
            <div class="form-group">
                <label for="NOMBRELARGO_ALIMENTO" class="col-sm-2 control-label">Nombre Largo Alimento: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="NOMBRELARGO_ALIMENTO" type="text" name="NOMBRELARGO_ALIMENTO" value='<?= $ali->getNombrelargoAlimento(); ?>' disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="CATEGORIA_IDCATEGORIA"  class="col-sm-2 control-label">Categoria: </label>
                <div class="col-sm-6">
                    <select name="CATEGORIA_IDCATEGORIA" id="CATEGORIA_IDCATEGORIA" class="form-control" disabled>
                        <?php
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" id="KCAL_X_100GR"  type="text" name="KCAL_X_100GR" value='<?= $ali->getKcalX100gr(); ?>' disabled/>
                </div>
            </div>
            <div class="form-group">
                <label for="GRAMOS_CC_PORCION" class="col-sm-2 control-label">Gramos por porción: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="GRAMOS_CC_PORCION" type="text" name="GRAMOS_CC_PORCION" value='<?= $ali->getGramosCcPorcion(); ?>' disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="PORCION_IDPORCION"  class="col-sm-2 control-label">Porción: </label>
                <div class="col-sm-6">
                    <select name="PORCION_IDPORCION" id="PORCION_IDPORCION" class="form-control" disabled>
                        <?php
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" id="CARBOHIDRATOS" type="text" name="CARBOHIDRATOS" value="<?= $ali->getCarbohidratos(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="PROTEINAS" class="col-sm-2 control-label">Proteínas: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="PROTEINAS" type="text" name="PROTEINAS" value="<?= $ali->getProteinas(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="GRASAS"  class="col-sm-2 control-label">Grasas: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="GRASAS" type="text" name="GRASAS" value="<?= $ali->getGrasas(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="MG_SODIO"  class="col-sm-2 control-label">Mg Sodio: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="MG_SODIO" type="text" name="MG_SODIO" value="<?= $ali->getMgSodio(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="AZUCARES"  class="col-sm-2 control-label">Azúcares: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="AZUCARES" type="text" name="AZUCARES" value="<?= $ali->getAzucares(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="TAMANIO_CHICO"  class="col-sm-2 control-label">Tamaño Chico: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="TAMANIO_CHICO" type="text" name="TAMANIO_CHICO" value="<?= $ali->getTamanioChico(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="TAMANIO_MEDIANO"  class="col-sm-2 control-label">Tamaño Mediano: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="TAMANIO_MEDIANO" type="text" name="TAMANIO_MEDIANO" value="<?= $ali->getTamanioMediano(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="TAMANIO_GRANDE"  class="col-sm-2 control-label">Tamaño Grande: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="TAMANIO_GRANDE" type="text" name="TAMANIO_GRANDE" value="<?= $ali->getTamanioGrande(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="IMAGEN"  class="col-sm-2 control-label">Imagen: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="IMAGEN" type="text" name="IMAGEN" value="<?= $ali->getImagen(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="FUENTE_KCALYDEMAS"  class="col-sm-2 control-label">Fuente Kcal y demás: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="FUENTE_KCALYDEMAS" type="text" name="FUENTE_KCALYDEMAS" value="<?= $ali->getFuenteKcalydemas(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="FUENTE_PORCION"  class="col-sm-2 control-label">Fuente Porción: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="FUENTE_PORCION" type="text" name="FUENTE_PORCION" value="<?= $ali->getFuentePorcion(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="ACLARACIONES_PUBLICAS" class="col-sm-2 control-label">Aclaraciones Públicas: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="ACLARACIONES_PUBLICAS" type="text" name="ACLARACIONES_PUBLICAS" value="<?= $ali->getAclaracionesPublicas(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <label for="COMENTARIOS_INTERNOS"  class="col-sm-2 control-label">Comentarios Internos: </label>
                <div class="col-sm-6">
                    <input class="form-control" id="COMENTARIOS_INTERNOS" type="text" name="COMENTARIOS_INTERNOS" value="<?= $ali->getComentariosInternos(); ?>" disabled />
                </div>
            </div>
            <div class="form-group">
