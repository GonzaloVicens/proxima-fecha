    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p>
                    <a href="#" class="naranjaFecha"><i class="far fa-edit"></i> Modificar Datos del Torneo</a>
                </p>
                <p>
                    <a href="#" class="naranjaFecha"><i class="fas fa-plus-circle"></i> Agregar Equipo</a>
                </p>
                <p>
                    <button href="#" class="naranjaFecha btn btn-lg btn-outline-warning"><i class="fas fa-trophy"></i> Generar Fixture</button>
                </p>
                <p class="d-none">
                    <button href="#" class="naranjaFecha btn btn-lg btn-outline-warning"><i class="fas fa-trophy"></i> Ver Fixture</button>
                </p>
            </div>
        </div>
    </div>
