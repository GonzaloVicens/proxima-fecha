...
class Usuario
{
    ...
    public static function imprimirUsuariosEnTabla()
    {
        ...
        while ($a = $stmt->fetch(\PDO::FETCH_ASSOC)) {
            ...
            if ($a['ACTIVO'] == 1) {
                echo "<td><a class='fa fa-trash fa-2x' title='Inactivar $a[USUARIO_ID]' href='adminPF/desactivar-usuario/$a[USUARIO_ID]'>Inactivar</a></td>";
            } else {
                echo "<td><a class='fa fa-pencil fa-2x' title='Activar $a[USUARIO_ID]' href='adminPF/activar-usuario/$a[USUARIO_ID]'>Activar</a></td>";
            }
            echo "</tr>";
        };
